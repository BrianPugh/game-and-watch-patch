...
class MarioGnW(Device):
    ...
    def __call__(self):
        ...
        def sram3_free_space():
            return len(self.sram3) - sram3_pos
        ...
        def move_to_sram3(ext, size, reference):
            ...
            try:
                self.sram3[sram3_pos : sram3_pos + size] = self.external[
                    ext : ext + size
                ]
            ...
            if diff > int_free_space():
                ...
                self.sram3.clear_range(sram3_pos, sram3_pos + size)
            ...
            self.move_to_sram3(ext, sram3_pos, size=size)
        ...
        if sram3_pos:
            ...
            self.internal.rwdata.append(
                self.sram3[:sram3_pos].copy(), self.sram3.FLASH_BASE
            )
        ...
        sram3_free = len(self.sram3) - sram3_pos
